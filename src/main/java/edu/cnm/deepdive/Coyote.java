...
public class Coyote extends Canis {
  ...
  public Coyote() {
    System.out.println("When the constructor completes, the coyote us ready to rumble");
  }

  @Override
  public void hunt() {
    System.out.println("Coyotes are solo or opportunistic pack hunters/scavengers");
  }
